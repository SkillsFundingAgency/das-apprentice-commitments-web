...
{
    [Binding]
    [Scope(Feature = "ConfirmHowYourApprenticeshipWillBeDelivered")]
    public class ConfirmHowYourApprenticeshipWillBeDeliveredSteps : StepsBase
    {
        ...
        public void ThenTheApprenticeshipIsUpdatedToShowTheAConfirmation(bool confirm)
        {
            var updates = _context.OuterApi.MockServer.FindLogEntries(
                Request.Create()
                    .WithPath($"/apprentices/*/apprenticeships/{_apprenticeshipId.Id}/statements/{_commitmentStatementId}/howapprenticeshipwillbedeliveredconfirmation")
                    .UsingPost());
